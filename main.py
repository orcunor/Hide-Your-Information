...
class popupWindow(object):
    ...
    def __init__(self, master):
        ...
        top.title('Giriş Şifresi')
        top.geometry('{}x{}'.format(250, 100))
        top.resizable(width=False, height=False)
        self.l = Label(top, text=" Şifre: ", font=('Courier', 14), justify=CENTER)
        self.l.pack()
        self.e = Entry(top, show='*', width=30)
        self.e.pack(pady=7)
        self.b = Button(top, text='Giriş', command=self.cleanup, font=('Courier', 14))
        self.b.pack()
    ...
    def cleanup(self):
        ...
        if self.value == access:
            ...
            if self.attempts == 5:
                window.quit()
            self.e .delete(0, 'end')
            messagebox.showerror('Hatalı Parola', 'Hatalı Parola, geriye kalan deneme: ' + str(5 - self.attempts))
...
class entity_display:
    ...
    def delete(self):
        answer = tkinter.messagebox.askquestion('Sil', 'Silmek istediğine emin misin aga?')
...
def onsubmit():
    ...
    messagebox.showinfo('Bilgi Ekle', 'Başarıyla Eklendi, \n' + 'Başlık: ' + n + '\nEmail(user): ' + m + '\nŞifre: ' + p)
    readfile()
...
entity_label = Label(window, text='Bilgi Ekle', font=('Courier', 18))
name_label = Label(window, text='Başlık: ', font=('Courier', 14))
email_label = Label(window, text='Email(user): ', font=('Courier', 14))
pass_label = Label(window, text='Şifre: ', font=('Courier', 14))
name = Entry(window, font=('Courier', 14))
email = Entry(window, font=('Courier', 14))
password = Entry(window, show='*', font=('Courier', 14))
submit = Button(window, text='Kayıt Ekle', command=onsubmit, font=('Courier', 14))
...
name_label2 = Label(window, text='Başlık: ', font=('Courier', 14))
email_label2 = Label(window, text='Email(user): ', font=('Courier', 14))
pass_label2 = Label(window, text='Şifre: ', font=('Courier', 14))
